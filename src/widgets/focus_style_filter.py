...
class FocusStyleFilter(QObject):
    def __init__(self, parent, initial_style,sys_bg):
        super().__init__(parent)
        self.initial_style = initial_style  # 控件初始样式
        self.r,self.g,self.b ,_ = sys_bg.getRgb()
            ...
            if main_window.keyboard_handler.is_shortcut_focus:
                ...
                obj.setStyleSheet(f"""
                    ...
                    QTreeWidget {{
                        ...
                        background-color: rgba({self.r},{self.g},{self.b},180);
                    }}
                """)
...
def install_focus_style_filter(widget, initial_style,sys_bg):
    """统一安装焦点样式过滤器"""
    filter_instance = FocusStyleFilter(widget, initial_style,sys_bg)
