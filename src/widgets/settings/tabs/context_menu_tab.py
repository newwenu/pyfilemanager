...
class ContextMenuTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        # 显示删除选项
        self.show_delete_checkbox = self._items.add_checkbox(
            file_list_layout, 'show_context_menu_delete',
            self.translation.get("chk_show_delete", "显示删除选项"),
            default_value=True
        )
        
        # 显示属性选项
        self.show_properties_checkbox = self._items.add_checkbox(
            file_list_layout, 'show_context_menu_properties',
            self.translation.get("chk_show_properties", "显示属性选项"),
            default_value=True
        )
        
        # 显示在资源管理器打开选项
        self.show_open_explorer_checkbox = self._items.add_checkbox(
            file_list_layout, 'show_context_menu_open_explorer',
            self.translation.get("chk_show_open_explorer", "显示在资源管理器打开选项"),
            default_value=True
        )
        
        # 显示新建文件夹选项
        self.show_new_folder_checkbox = self._items.add_checkbox(
            file_list_layout, 'show_context_menu_new_folder',
            self.translation.get("chk_show_new_folder", "显示新建文件夹选项"),
            default_value=True
        )
        ...
        # 显示新建文件夹选项（空白区域）
        self.show_blank_new_folder_checkbox = self._items.add_checkbox(
            blank_area_layout, 'show_blank_menu_new_folder',
            self.translation.get("chk_show_blank_new_folder", "显示新建文件夹选项"),
            default_value=True
        )
        
        # 显示在资源管理器打开选项（空白区域）
        self.show_blank_open_explorer_checkbox = self._items.add_checkbox(
            blank_area_layout, 'show_blank_menu_open_explorer',
            self.translation.get("chk_show_blank_open_explorer", "显示在资源管理器打开选项"),
            default_value=True
        )
