from PySide6.QtWidgets import (QWidget, QVBoxLayout, QLabel, QSplitter, QHBoxLayout,
                               ...
                               QAbstractItemView, QStatusBar,QStackedWidget)  # 新增QStatusBar导入

from PySide6.QtGui import QFont,QColor  # 新增：导入QFont用于字体设置
...
from widgets.focus_style_filter import FocusStyleFilter, install_focus_style_filter  # 新增导入
from PySide6.QtWidgets import QGraphicsBlurEffect ,QGraphicsDropShadowEffect,QGraphicsEffect   # 新增：模糊效果组件
from PySide6.QtGui import *
from PySide6.QtWidgets import QPushButton
from PySide6.QtGui import QPainter, QPainterPath, QColor
from PySide6.QtCore import Qt
from widgets.rounded_button import AntiAliasRoundedButton  # 新增：导入自定义按钮类
...
# 右侧内容容器（使用QStackedWidget管理切换）
    ...
    # 新增：使用QFont设置字体大小（替代原样式表中的font-size）
    file_font = QFont('等线')
